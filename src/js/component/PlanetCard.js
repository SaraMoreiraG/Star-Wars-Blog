...
function PlanetCard( { id } ) {
	let imgSrc = "https://starwars-visualguide.com/assets/img/planets/" + id + ".jpg";
	if (id == 1)
		imgSrc = 'https://img1.starwars-holonet.com/holonet/dictionnaire/photos/planete_tatooine.jpg';
